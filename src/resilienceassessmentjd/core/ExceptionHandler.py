...
class ExceptionHandler:
    ...
    def notify_maintenance_team(error, context):
        ...
        logger.info(
            f"Notification sent to maintenance team about system error in {context}: {error.message}"
        )
    ...
    def notify_development_team(error, context):
        ...
        logger.info(
            f"Notification sent to development team about unexpected error in {context}: {error.message}"
        )
...
class BusinessException(Exception):
    ...
    def __init__(
        self, message="Business exception occurred", code=ErrorCodes.BUSINESS_ERROR
    ):
...
class SystemException(Exception):
    ...
    def __init__(
        self, message="System exception occurred", code=ErrorCodes.SYSTEM_ERROR
    ):
        self.message = message
        self.code = code
        super().__init__(self.message)
...
class CustomException(Exception):
    ...
    def __init__(
        self, message="An unexpected error occurred", code=ErrorCodes.UNKNOWN_ERROR
    ):
        self.message = message
        self.code = code
        super().__init__(self.message)
